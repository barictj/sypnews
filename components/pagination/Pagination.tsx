...
export const Pagination = ({ props }) => {
    ...
    return(
        <div className={styles.pagination_div}>
            {pageNumber > 1 ? <div className={styles.button_div}><a onClick={goFirst} className={styles.button}>1</a></div>:<div className={styles.button_div}><a className={styles.inactive}>1 </a></div>}
